...
END
wget -q -O /var/www/html/index.html https://raw.githubusercontent.com/Hermananza/v4/main/index.html
# wget -q -O /etc/nginx/nginx.conf https://raw.githubusercontent.com/Hermananza/v4/main/nginx.conf
systemctl restart nginx
...
cd /usr/bin
GITHUB=raw.githubusercontent.com/Hermananza/v4/main
